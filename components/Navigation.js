...
export default function Navigation() {
  ...
  const getNavLinks = () => {
    if (isRawnnPage) {
      return {
        home: '/',
        benefits: '/rawnn#benefits',
        features: '/rawnn#features',
        products: '/#products',
        rawnn: '/rawnn',
        contact: '/rawnn#demo'
      }
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <a href={navLinks.home} className="text-gray-700 hover:text-primary-600 px-3 py-2 text-sm font-medium transition-colors">
                  ...
                  <a href={navLinks.benefits} className="text-gray-700 hover:text-primary-600 px-3 py-2 text-sm font-medium transition-colors">
                    Benefits
                  </a>
        ...
        <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
            <a href={navLinks.home} className="text-gray-700 hover:text-primary-600 block px-3 py-2 text-base font-medium">
              ...
              <a href={navLinks.benefits} className="text-gray-700 hover:text-primary-600 block px-3 py-2 text-base font-medium">
                Benefits
              </a>
