  ...
  const values = [
    {
      ...
      description: "We stay ahead of technology trends and continuously explore new ways to solve business challenges."
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Quality Focus",
      description: "Every line of code, every feature, and every product undergoes rigorous testing and quality assurance."
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "We work closely with our clients as true partners, understanding their business and contributing to their success."
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Technology evolves rapidly, and so do we. We invest in learning and staying current with industry best practices."
    }
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-8">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  Build and own innovative software products
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  Our dual approach of providing custom development services while building our own products
                  allows us to stay at the forefront of technology trends and deliver cutting-edge solutions.
                </p>
              </div>
            </div>
          </div>
